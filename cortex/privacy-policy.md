...
description: Privacy Policy for The Speddish Cortex mobile application
date: 2025-11-10
last_modified: 2025-11-10
---

# Privacy Policy - The Speddish Cortex

**Last Updated:** November 7, 2025

## 1. Introduction

Welcome to The Speddish Cortex. We respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard your information when you use our mobile application.

## 2. Information We Collect

### 2.1 Information You Provide
- **Account Information**: When you sign in with Google, we collect your email address and basic profile information
- **User-Generated Content**: Your flashcards, notes, study materials, and study progress data
- **Images**: Photos or images you select from your device's gallery for use in the app

### 2.2 Automatically Collected Information
- **Usage Data**: How you interact with the app, features used, and study patterns
...
- Store and sync your study data across devices
...
- **Data Storage**: Your personal data and study materials are stored securely on Firebase servers
...
- **Gallery Access**: The app can access your device's photo gallery to select images for study materials
- **No Camera Access**: The app does **NOT** access your device's camera and cannot take photos
- **Image Usage**: Selected images are stored securely and used only within the app for your study materials
...
**Note**: This privacy policy covers The Speddish Cortex mobile application for Android and iOS devices.